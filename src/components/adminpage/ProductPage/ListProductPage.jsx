  ...
  return (
    <div className="col-10 content">
      <div className="row mt-3 mb-3 header_content">
        ...
        <div className="col-4 click_content">
          {" "}
          <NavLink to="/addproduct">Thêm Sản Phẩm</NavLink>
        </div>
        <div className="col-4"></div>
      </div>
                                          ...
                                          >
                                            <div className="mb-3">
                                              <label
                                                ...
                                                className="form-label tille_content"
                                              >
                                                Tên Sản Phẩm
                                              </label>
                                              <input
